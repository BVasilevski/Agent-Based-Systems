...
if __name__ == "__main__":
    ...
    run_name = f"{args.env_id}__{args.total_timesteps}__{args.learning_rate}__{args.num_steps}__{args.num_envs}"
    if args.track:
        import wandb
    ...
    torch.save(q_network.state_dict(),
               f"models/pqn_{args.env_id}_ts-{args.total_timesteps}_lr-{args.learning_rate}_ns-{args.num_steps}_ne-{args.num_envs}.pth")
    envs.close()
    writer.close()
