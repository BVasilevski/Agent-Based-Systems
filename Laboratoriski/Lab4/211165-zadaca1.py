...
class DQN:
    def __init__(self, state_space_shape, num_actions, model, target_model, learning_rate=0.1,
        ...
        :param state_space_shape: shape of the observation spacecd
...
if __name__ == '__main__':
    ...
    for episode in range(1, num_episodes + 1):
        ...
        if episode % 50 == 0:
            agent.save('lunar_lander_agent', episode)
    ...
    for iteration in [50, 100]:
        ...
        iters[iteration] = f'Average reward: {avg_reward}'

    print(iters)
    env.close()

'''
Za 50 iteracii dobivam prosecna nagrada od -364
Za 100 iteracii dobivam prosecna nagrada od -440
'''
