...
from Lab3.deep_q_learning import *
...
def build_model(state_space_shape, num_actions):
    ...
    model.add(Conv1D(8, activation='relu'))
    model.add(Conv1D(4, activation='relu'))
...
if __name__ == '__main__':
    ...
    #     if episode % 100 == 0:
    #         agent.save('conv-model', episode=episode)
    #
    # agent.save('conv-model', episode=episode + 1)
